...
function init_gear_sets()
	...
	sets.precast.FC = {head="Nahtirah Hat",ear2="Loquac. Earring",
        hands="Brioso cuffs +1",ring1="Prolix Ring",
        back="Intarabus's cape",waist="Witful Belt",legs="Ayanmo cosciales +2",feet="Chelona Boots +1"}
	...
	sets.midcast.SongEffect = {head="Brioso Roundlet +2",neck="Moonbow whistle",ear2="Loquacious Earring", ear1="Musical earring",
        body="Fili Hongreline +1",hands="Fili Manchettes",
        back="Intarabus's cape",waist="Harfner's sash",legs="Inyanga Shalwar +2",feet="Brioso Slippers +3"}
	...
	sets.midcast.Cure = {main="Serenity",sub="Curatio Grip",
        ...
        body="Gendewitha bliaut",hands="Inyanga dastanas +1",ring1="Ephedra ring",ring2="Menelaus's Ring",
        back="Dispercer's cape",waist="Bishop's sash",legs="Vanya slops",feet="Vanya clogs"}
		
	sets.Self_Healing = {neck="Phalaina Locket",hands="Buremte Gloves",ring2="Kunaji Ring",waist="Gishdubar Sash"}
	sets.Cure_Received = {neck="Phalaina Locket",hands="Buremte Gloves",ring2="Kunaji Ring",waist="Gishdubar Sash"}
	sets.Self_Refresh = {back="Grapevine Cape",waist="Gishdubar Sash"}
		
	sets.midcast['Enhancing Magic'] = {main="Serenity",sub="Fulcio Grip",
	...
	sets.idle = {
		head="Ayanmo zucchetto +2",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Ayanmo corazza +2",hands="Ayanmo manopolas +2",ring1="Fortified ring",ring2="Spiral ring",
		back="Umbra Cape",waist="Flume Belt",legs="Assid. Pants",feet="Fili Cothurnes"}

	sets.idle.PDT ={ head="Ayanmo zucchetto +2",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Ayanmo corazza +2",hands="Ayanmo manopolas +2",ring1="Fortified ring",ring2="Spiral ring",
		back="Umbra Cape",waist="Flume Belt",legs="Assid. Pants",feet="Fili Cothurnes"}
