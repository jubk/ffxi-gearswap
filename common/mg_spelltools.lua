local spelltools = function()
    local roman_numerics = {
        ['I'] = 1,
        ['II'] = 2,
        ['III'] = 3,
        ['IV'] = 4,
    ...
    local downgrade_map = nil;

    local function split_spell_basename_and_tier(spellname)
        local idx = 0;
        local lastpos = idx;
    ...
    local function _cancel_spell(eventArgs)
        if eventArgs then
    ...
    local function check_addendum(spell, eventArgs)
    ...
    local function activate_light_arts(eventArgs)
        if not (
    ...
    local function activate_dark_arts(eventArgs)
        if not (
    ...
    local function get_mp_cost_factor(spell)
    ...
    local function downgrade_spell(player, spell, eventArgs)
    ...
    return {
        setup_spellcost_map=setup_spellcost_map,
        downgrade_spell=downgrade_spell,
        check_addendum=check_addendum,
        activate_light_arts=activate_light_arts,
        activate_dark_arts=activate_dark_arts
    }
end
