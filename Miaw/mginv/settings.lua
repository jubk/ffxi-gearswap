...
function setup()
    ...
    -- Mog Wardrobe (used):
    fixed_position["Adhemar Bonnet +1{'DEX+12','AGI+12','Accuracy+20'}"] = "Mog Wardrobe" -- Used by 2 jobs: COR, THF
    fixed_position["Adhemar Jacket +1{'DEX+12','AGI+12','Accuracy+20'}"] = "Mog Wardrobe" -- Used by 2 jobs: COR, THF
    fixed_position["Adhemar Wrist. +1{'DEX+12','AGI+12','Accuracy+20'}"] = "Mog Wardrobe" -- Used by 1 jobs: COR
    fixed_position["Aegis{}"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    ...
    fixed_position["Begrudging Ring"] = "Mog Wardrobe" -- Used by 2 jobs: COR, PLD
    fixed_position["Brutal Earring"] = "Mog Wardrobe" -- Used by 2 jobs: BRD, COR
    fixed_position["Burtgang"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Cab. Breeches{'Enhances \"Invincible\" effect'}"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Cab. Coronet +1{'Enhances \"Iron Will\" effect'}"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Cab. Gauntlets +1{'Enhances \"Chivalry\" effect'}"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Cab. Leggings +1{'Enhances \"Guardian\" effect'}"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Cab. Surcoat +1{'Enhances \"Fealty\" effect'}"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Cacoethic Ring"] = "Mog Wardrobe" -- Used by 5 jobs: COR, DRK, GEO, PLD, THF
    fixed_position["Cacoethic Ring +1"] = "Mog Wardrobe" -- Used by 5 jobs: COR, DRK, GEO, PLD, THF
    fixed_position["Camulus's Mantle{'DEX+20','Accuracy+20 Attack+20','Accuracy+10','\"Dbl.Atk.\"+10','Phys. dmg. taken-10%'}"] = "Mog Wardrobe" -- Used by 1 jobs: COR
    ...
    fixed_position["Cessance Earring"] = "Mog Wardrobe" -- Used by 5 jobs: BRD, COR, PLD, RNG, THF
    fixed_position["Chaac Belt"] = "Mog Wardrobe" -- Used by 2 jobs: COR, SCH
    ...
    fixed_position["Defending Ring"] = "Mog Wardrobe" -- Used by 5 jobs: BRD, COR, PLD, RNG, SCH
    fixed_position["Diemer Gorget"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Dim. Ring (Holla)"] = "Mog Wardrobe" -- Used by 1 jobs: BRD
    fixed_position["Epona's Ring"] = "Mog Wardrobe" -- Used by 2 jobs: COR, THF
    ...
    fixed_position["Floral Gauntlets{'Rng.Acc.+14','Accuracy+13','\"Triple Atk.\"+2','Magic dmg. taken -3%'}"] = "Mog Wardrobe" -- Used by 1 jobs: COR
    ...
    fixed_position["Friomisi Earring"] = "Mog Wardrobe" -- Used by 8 jobs: BLM, BRD, COR, DRK, GEO, PLD, RNG, THF
    ...
    fixed_position["Kentarch Belt +1"] = "Mog Wardrobe" -- Used by 3 jobs: PLD, RNG, THF
    fixed_position["Loess Barbuta"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Mendi. Earring"] = "Mog Wardrobe" -- Used by 3 jobs: BRD, PLD, SCH
    ...
    fixed_position["Ochain{}"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    floating_position["Odnowa Earring"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    floating_position["Odnowa Earring +1"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Odyssean Greaves{'Accuracy+10','\"Fast Cast\"+5','Attack+13'}"] = "Mog Wardrobe" -- Used by 2 jobs: DRK, PLD
    fixed_position["Olseni Belt"] = "Mog Wardrobe" -- Used by 4 jobs: BRD, BST, COR, PLD
    fixed_position["Petrov Ring"] = "Mog Wardrobe" -- Used by 3 jobs: BRD, COR, THF
    fixed_position["Purity Ring"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Reiki Cloak"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Rev. Coronet +1"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    ...
    fixed_position["Shetal Stone"] = "Mog Wardrobe" -- Used by 2 jobs: COR, THF
    fixed_position["Shiva Ring +1"] = "Mog Wardrobe" -- Used by 3 jobs: BRD, PLD, THF
    ...
    fixed_position["Staunch Tathlum"] = "Mog Wardrobe" -- Used by 3 jobs: BRD, PLD, SCH
    ...
    fixed_position["Suppanomimi"] = "Mog Wardrobe" -- Used by 3 jobs: BRD, COR, THF
    fixed_position["Trizek Ring"] = "Mog Wardrobe" -- Used by 1 jobs: BRD
    fixed_position["Trux Earring"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Varar Ring"] = "Mog Wardrobe" -- Used by 1 jobs: BST
    fixed_position["Vengeful Ring"] = "Mog Wardrobe" -- Used by 1 jobs: PLD
    fixed_position["Vocane Ring"] = "Mog Wardrobe" -- Used by 5 jobs: BRD, COR, PLD, RNG, SCH
    fixed_position["Volte Jupon"] = "Mog Wardrobe" -- Used by 2 jobs: COR, SCH
    fixed_position["Warp Ring"] = "Mog Wardrobe" -- Used by 1 jobs: BRD
    ...
    fixed_position["Ammurapi Shield"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    fixed_position["Andoaa Earring"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    ...
    fixed_position["Arbatel Loafers +1"] = "Mog Wardrobe 2" -- Used by 1 jobs: SCH
    fixed_position["Arbatel Pants +1"] = "Mog Wardrobe 2" -- Used by 1 jobs: SCH
    fixed_position["Barkaro. Earring"] = "Mog Wardrobe 2" -- Used by 3 jobs: BLM, GEO, SCH
    fixed_position["Bishop's Sash"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    ...
    fixed_position["Channeler's Stone"] = "Mog Wardrobe 2" -- Used by 4 jobs: BLM, BRD, GEO, SCH
    ...
    fixed_position["Clerisy Strap"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    fixed_position["Digni. Earring"] = "Mog Wardrobe 2" -- Used by 9 jobs: BLM, BRD, BST, COR, DRK, GEO, PLD, SCH, THF
    fixed_position["Doyen Pants"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    ...
    fixed_position["Etana Ring"] = "Mog Wardrobe 2" -- Used by 6 jobs: BLM, BRD, COR, DRK, GEO, SCH
    fixed_position["Etiolation Earring"] = "Mog Wardrobe 2" -- Used by 5 jobs: BLM, BRD, COR, GEO, SCH
    ...
    fixed_position["Genmei Shield"] = "Mog Wardrobe 2" -- Used by 3 jobs: BRD, GEO, SCH
    fixed_position["Grioavolr{'\"Fast Cast\"+5','MP+32','Mag. Acc.+9','Magic Damage +3'}"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    fixed_position["Hachirin-no-Obi"] = "Mog Wardrobe 2" -- Used by 1 jobs: SCH
    ...
    fixed_position["Kishar Ring"] = "Mog Wardrobe 2" -- Used by 4 jobs: BLM, BRD, COR, SCH
    fixed_position["Locus Ring"] = "Mog Wardrobe 2" -- Used by 1 jobs: SCH
    fixed_position["Loquac. Earring"] = "Mog Wardrobe 2" -- Used by 8 jobs: BLM, BRD, COR, DRK, GEO, PLD, RNG, SCH
    ...
    fixed_position["Luminary Sash"] = "Mog Wardrobe 2" -- Used by 4 jobs: BLM, BRD, GEO, SCH
    ...
    fixed_position["Nodens Gorget"] = "Mog Wardrobe 2" -- Used by 4 jobs: BLM, BRD, GEO, SCH
    fixed_position["Pahtli Cape"] = "Mog Wardrobe 2" -- Used by 4 jobs: BLM, BRD, GEO, SCH
    ...
    fixed_position["Peda. Loafers +3{'Enhances \"Stormsurge\" effect'}"] = "Mog Wardrobe 2" -- Used by 1 jobs: SCH
    ...
    fixed_position["Prolix Ring"] = "Mog Wardrobe 2" -- Used by 7 jobs: BLM, BRD, COR, DRK, GEO, RNG, SCH
    fixed_position["Refoccilation Stone"] = "Mog Wardrobe 2" -- Used by 3 jobs: BLM, GEO, SCH
    fixed_position["Regal Earring"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    fixed_position["Sanctity Necklace"] = "Mog Wardrobe 2" -- Used by 9 jobs: BLM, BRD, COR, DRK, GEO, PLD, RNG, SCH, THF
    ...
    fixed_position["Solemnity Cape"] = "Mog Wardrobe 2" -- Used by 3 jobs: BRD, COR, SCH
    fixed_position["Swith Cape +1"] = "Mog Wardrobe 2" -- Used by 3 jobs: BLM, GEO, SCH
    fixed_position["Telchine Braconi{'Enh. Mag. eff. dur. +10'}"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    fixed_position["Telchine Cap{'Enh. Mag. eff. dur. +10'}"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    fixed_position["Telchine Gloves{'\"Cure\" potency +4%','Enh. Mag. eff. dur. +10'}"] = "Mog Wardrobe 2" -- Used by 4 jobs: BLM, BRD, GEO, SCH
    fixed_position["Telchine Pigaches{'Enh. Mag. eff. dur. +9'}"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    fixed_position["Twilight Cape"] = "Mog Wardrobe 2" -- Used by 1 jobs: SCH
    fixed_position["Vanya Clogs{'\"Cure\" potency +5%','\"Cure\" spellcasting time -15%','\"Conserve MP\"+6'}"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    fixed_position["Volte Gaiters"] = "Mog Wardrobe 2" -- Used by 2 jobs: BRD, SCH
    fixed_position["Voltsurge Torque"] = "Mog Wardrobe 2" -- Used by 8 jobs: BLM, BRD, COR, DRK, GEO, PLD, RNG, SCH
    -- Count: 80
    ...
    fixed_position["Death Penalty{'Path: A'}"] = "Mog Wardrobe 3" -- Used by 1 jobs: COR
    ...
    fixed_position["Herculean Boots{'Accuracy+25 Attack+25','\"Triple Atk.\"+4','AGI+7'}"] = "Mog Wardrobe 3" -- Used by 1 jobs: COR
    ...
    fixed_position["Lanun Gants +3{'Enhances \"Fold\" effect'}"] = "Mog Wardrobe 3" -- Used by 1 jobs: COR
    ...
    fixed_position["Aya. Cosciales +1"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Aya. Gambieras +2"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Aya. Manopolas +1"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Aya. Zucchetto +2"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Ayanmo Corazza +1"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Befouled Crown"] = "Mog Wardrobe 4" -- Used by 1 jobs: SCH
    fixed_position["Bihu Cannions +2{'Enhances \"Soul Voice\" effect'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Bihu Jstcorps. +3{'Enhances \"Troubadour\" effect'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Bihu Slippers +1{'Enhances \"Nightingale\" effect'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Brioso Roundlet +1"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Brioso Slippers +2"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Combatant's Torque"] = "Mog Wardrobe 4" -- Used by 2 jobs: BRD, COR
    fixed_position["Comm. Charm +2{'Path: A'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: COR
    fixed_position["Darraigner's Brais"] = "Mog Wardrobe 4" -- Used by 1 jobs: COR
    fixed_position["Daurdabla{}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Daybreak"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Eabani Earring"] = "Mog Wardrobe 4" -- Used by 1 jobs: COR
    fixed_position["Eddy Necklace"] = "Mog Wardrobe 4" -- Used by 2 jobs: BLM, GEO
    fixed_position["Empath Necklace"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    fixed_position["Fili Calot +1"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Fili Cothurnes +1"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Fili Hongreline +1"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Fili Manchettes +1"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Fili Rhingrave +1"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Fomalhaut"] = "Mog Wardrobe 4" -- Used by 1 jobs: COR
    fixed_position["Gjallarhorn{}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Gyve Trousers"] = "Mog Wardrobe 4" -- Used by 3 jobs: BLM, BRD, GEO
    ...
    fixed_position["Homiliary"] = "Mog Wardrobe 4" -- Used by 1 jobs: SCH
    fixed_position["Ilabrat Ring"] = "Mog Wardrobe 4" -- Used by 3 jobs: BRD, COR, RNG
    fixed_position["Intarabus's Cape{'CHR+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','\"Fast Cast\"+10'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Inyan. Dastanas +2"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Inyanga Jubbah +2"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Inyanga Shalwar +2"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    ...
    fixed_position["Kali"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Kayapa Cape"] = "Mog Wardrobe 4" -- Used by 3 jobs: BRD, DRK, GEO
    fixed_position["Malignance Chapeau"] = "Mog Wardrobe 4" -- Used by 1 jobs: COR
    fixed_position["Malignance Earring"] = "Mog Wardrobe 4" -- Used by 1 jobs: SCH
    fixed_position["Malignance Tights"] = "Mog Wardrobe 4" -- Used by 2 jobs: COR, RNG
    fixed_position["Marsyas"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    ...
    fixed_position["Mnbw. Whistle +1"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    fixed_position["Mummu Ring"] = "Mog Wardrobe 4" -- Used by 1 jobs: COR
    fixed_position["Mummu Wrists +2"] = "Mog Wardrobe 4" -- Used by 1 jobs: COR
    fixed_position["Oshosi Leggings"] = "Mog Wardrobe 4" -- Used by 1 jobs: COR
    fixed_position["Sangoma"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    ...
    fixed_position["Taeon Boots{'Accuracy+22','\"Dual Wield\"+5','DEX+9'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: COR
    fixed_position["Telchine Chas.{'Enh. Mag. eff. dur. +9'}"] = "Mog Wardrobe 4" -- Used by 3 jobs: BLM, BRD, GEO
    fixed_position["Valorous Mask{'Pet: Accuracy+30 Pet: Rng. Acc.+30','Pet: DEX+6'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    fixed_position["Varar Ring"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    fixed_position["Volte Boots"] = "Mog Wardrobe 4" -- Used by 2 jobs: COR, SCH
    fixed_position["Volte Gloves"] = "Mog Wardrobe 4" -- Used by 1 jobs: BRD
    -- Mog Wardrobe 4 (unused):
    floating_position["Baetyl Pendant"] = "Mog Wardrobe 4" -- Not used
    floating_position["Hermetic Earring"] = "Mog Wardrobe 4" -- Not used
    -- Count: 66
    ...
    fixed_position["Ferine Earring"] = "Storage"
    fixed_position["Tali'ah Ring"] = "Storage"
    fixed_position["Aganoshe{'\"Store TP\"+6','DEX+8','Accuracy+21','Attack+2','DMG:+26'}"] = "Storage" -- Not used
    fixed_position["Bloodrain Strap"] = "Storage" -- Not used
    fixed_position["Bubbly Broth"] = "Storage" -- Not used
    fixed_position["Charmer's Merlin"] = "Storage" -- Not used
    fixed_position["Deathbane"] = "Storage" -- Not used
    fixed_position["Jokushuono"] = "Storage" -- Not used
    fixed_position["Sandung"] = "Storage" -- Not used
    fixed_position["Skullrender{'DMG:+15','Pet: Accuracy+20','Pet: Attack+20'}"] = "Storage" -- Not used
    fixed_position["Taming Sari{'STR+10','DEX+10','DMG:+15','\"Treasure Hunter\"+1'}"] = "Storage" -- Not used
    fixed_position["Lathi{'INT+15','\"Mag.Atk.Bns.\"+15','Mag. Acc.+15'}"] = "Storage" -- Used by 1 jobs: BLM
    fixed_position["Bane Cape{'Elem. magic skill +10','Dark magic skill +6','\"Mag.Atk.Bns.\"+1'}"] = "Storage" -- Used by 1 jobs: BLM
    fixed_position["Canny Cape{'DEX+3','AGI+2','\"Dual Wield\"+4'}"] = "Storage" -- Used by 1 jobs: THF
    fixed_position["Dunna{'MP+20','Mag. Acc.+10','\"Fast Cast\"+3'}"] = "Storage" -- Used by 1 jobs: GEO
    fixed_position["Herculean Vest{'Mag. Acc.+18 \"Mag.Atk.Bns.\"+18','INT+10','\"Mag.Atk.Bns.\"+11'}"] = "Storage" -- Used by 1 jobs: THF
    fixed_position["Lifestream Cape{'Geomancy Skill +8','Indi. eff. dur. +16','Pet: Damage taken -3%'}"] = "Storage" -- Used by 1 jobs: GEO
    fixed_position["Merlinic Jubbah{'\"Mag.Atk.Bns.\"+27','Magic burst dmg.+10%','INT+13','Mag. Acc.+3'}"] = "Storage" -- Used by 1 jobs: BLM
    fixed_position["Gende. Gages +1"] = "Storage" -- Used by 1 jobs: GEO
    fixed_position["Hike Khat"] = "Storage" -- Used by 1 jobs: GEO
    fixed_position["Jute Boots +1"] = "Storage" -- Used by 1 jobs: THF
    fixed_position["Moonbeam Ring"] = "Storage" -- Used by 1 jobs: THF
    fixed_position["Persis Ring"] = "Storage" -- Used by 1 jobs: BLM
    fixed_position["Plun. Armlets +1{'Enhances \"Perfect Dodge\" effect'}"] = "Storage" -- Used by 1 jobs: THF
    fixed_position["Seething Bomblet"] = "Storage" -- Used by 1 jobs: THF
    fixed_position["Skulk. Poulaines"] = "Storage" -- Used by 1 jobs: THF
    fixed_position["Taranus's Cape{'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','\"Mag.Atk.Bns.\"+10'}"] = "Storage" -- Used by 1 jobs: BLM
    fixed_position["Toutatis's Cape{'INT+20','Mag. Acc+20 /Mag. Dmg.+20','INT+10','Weapon skill damage +10%'}"] = "Storage" -- Used by 1 jobs: THF

    fixed_position["Belenus's Cape{'\"Snapshot\"+10'}"] = "Mog Locker" -- Used by 1 jobs: RNG
    fixed_position["Belenus's Cape{'AGI+20','Mag. Acc+20 /Mag. Dmg.+20','AGI+10','Weapon skill damage +10%'}"] = "Mog Locker" -- Used by 1 jobs: RNG
    fixed_position["Belenus's Cape{'AGI+20','Rng.Acc.+20 Rng.Atk.+20','\"Store TP\"+10'}"] = "Mog Locker" -- Used by 1 jobs: RNG
    fixed_position["Belenus's Cape{'AGI+20','Rng.Acc.+20 Rng.Atk.+20','AGI+10','Weapon skill damage +10%'}"] = "Mog Locker" -- Used by 1 jobs: RNG
    fixed_position["Hunter's Braccae"] = "Mog Locker" -- Used by 1 jobs: RNG
    fixed_position["Impulse Belt"] = "Mog Locker" -- Used by 1 jobs: RNG
    fixed_position["Meghanada Ring"] = "Mog Locker" -- Used by 1 jobs: RNG
    fixed_position["Ocachi Gorget"] = "Mog Locker" -- Used by 1 jobs: RNG
    fixed_position["Orion Beret +2"] = "Mog Locker" -- Used by 1 jobs: RNG
    fixed_position["Perun +1"] = "Mog Locker" -- Used by 1 jobs: RNG
    floating_position["Sarissapho. Belt"] = "Mog Locker" -- Used by 1 jobs: RNG
    floating_position["Scout's Socks"] = "Mog Locker" -- Used by 1 jobs: RNG
    floating_position["Sherida Earring"] = "Mog Locker" -- Used by 1 jobs: RNG
    fixed_position["Herculean Helm{'Weapon skill damage +4%','DEX+9','Rng.Acc.+6','Rng.Atk.+10'}"] = "Mog Locker"
