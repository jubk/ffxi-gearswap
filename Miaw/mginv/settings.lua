...
function setup()
    ...
    fixed_position["Gunslinger's Cape{'Enmity-2','\"Mag.Atk.Bns.\"+4','\"Phantom Roll\" ability delay -5'}"] = "Mog Wardrobe 3" -- Used by 1 jobs: COR
    ...
    floating_position["Windbuffet Belt +1"] = "Mog Wardrobe 3" -- Not used
