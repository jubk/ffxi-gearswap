...
function setup(fixed_position, floating_position)
    ...
    fixed_position["Bladeborn Earring"] = "Mog Wardrobe" -- Used by 1 jobs: DRK
    ...
    fixed_position["Founder's Corona{'DEX+9','Accuracy+14','Mag. Acc.+15','Magic dmg. taken -4%'}"] = "Mog Wardrobe" -- Used by 1 jobs: DRK
    ...
    fixed_position["Knobkierrie"] = "Mog Wardrobe" -- Used by 1 jobs: DRK
    ...
    fixed_position["Odyss. Chestplate{'Mag. Acc.+21','\"Fast Cast\"+4','AGI+9','\"Mag.Atk.Bns.\"+15'}"] = "Mog Wardrobe" -- Used by 1 jobs: DRK
    ...
    fixed_position["Sailfi Belt"] = "Mog Wardrobe" -- Used by 1 jobs: DRK
    ...
    fixed_position["Sulev. Cuisses +2"] = "Mog Wardrobe" -- Used by 1 jobs: DRK
    fixed_position["Sulev. Gauntlets +2"] = "Mog Wardrobe" -- Used by 1 jobs: DRK
    fixed_position["Sulev. Leggings +2"] = "Mog Wardrobe" -- Used by 1 jobs: DRK
    ...
    fixed_position["Ghastly Tathlum"] = "Mog Wardrobe 2" -- Used by 3 jobs: BLM, PLD, SCH
    ...
    fixed_position["Terra's Staff"] = "Mog Wardrobe 2" -- Used by 1 jobs: SCH
    ...
    -- Mog Wardrobe 3 (used):
    fixed_position["Adhemar Kecks +1{'AGI+12','Rng.Acc.+20','Rng.Atk.+20'}"] = "Mog Wardrobe 3" -- Used by 2 jobs: COR, RNG
    ...
    fixed_position["Camulus's Mantle{'DEX+20','Accuracy+20 Attack+20','Accuracy+5','\"Store TP\"+10'}"] = "Mog Wardrobe 3" -- Used by 1 jobs: COR
    fixed_position["Carmine Fin. Ga. +1{'Rng.Atk.+20','\"Mag.Atk.Bns.\"+12','\"Store TP\"+6'}"] = "Mog Wardrobe 3" -- Used by 1 jobs: RNG
    ...
    fixed_position["Commodore Charm"] = "Mog Wardrobe 3" -- Used by 1 jobs: COR
    fixed_position["Dingir Ring"] = "Mog Wardrobe 3" -- Used by 3 jobs: COR, RNG, THF
    fixed_position["Enervating Earring"] = "Mog Wardrobe 3" -- Used by 1 jobs: RNG
    fixed_position["Herculean Boots{'Rng.Acc.+14 Rng.Atk.+14','Weapon skill damage +3%','Rng.Acc.+2','Rng.Atk.+12'}"] = "Mog Wardrobe 3" -- Used by 1 jobs: RNG
    ...
    fixed_position["Impulse Belt"] = "Mog Wardrobe 3" -- Used by 2 jobs: COR, RNG
    fixed_position["Ishvara Earring"] = "Mog Wardrobe 3" -- Used by 2 jobs: COR, RNG
    ...
    fixed_position["Lanun Gants +1{'Enhances \"Fold\" effect'}"] = "Mog Wardrobe 3" -- Used by 1 jobs: COR
    fixed_position["Lanun Trews +1{'Enhances \"Snake Eye\" effect'}"] = "Mog Wardrobe 3" -- Used by 1 jobs: COR
    fixed_position["Lanun Tricorne +2{'Enhances \"Winning Streak\" effect'}"] = "Mog Wardrobe 3" -- Used by 1 jobs: COR
    fixed_position["Loricate Torque +1"] = "Mog Wardrobe 3" -- Used by 2 jobs: RNG, SCH
    ...
    fixed_position["Meghanada Ring"] = "Mog Wardrobe 3" -- Used by 2 jobs: COR, RNG
    fixed_position["Meghanada Visor +2"] = "Mog Wardrobe 3" -- Used by 3 jobs: COR, RNG, THF
    fixed_position["Moonshade Earring{'Rng.Atk.+4','TP Bonus +250'}"] = "Mog Wardrobe 3" -- Used by 2 jobs: COR, RNG
    ...
    fixed_position["Oshosi Vest"] = "Mog Wardrobe 3" -- Used by 1 jobs: RNG
    fixed_position["Pixie Hairpin +1"] = "Mog Wardrobe 3" -- Used by 3 jobs: BLM, COR, SCH
    ...
    fixed_position["Armageddon"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Ataktos{'Delay:+60','TP Bonus +1000'}"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Death Penalty"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Demers. Degen +1"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Fettering Blade"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Hep. Rapier +1"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Hunter's Braccae"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Kustawi +1"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Lak. Gants +1"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Lak. Hat +1"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Laksa. Trews +2"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Malevolence{'INT+10','Mag. Acc.+10','\"Mag.Atk.Bns.\"+8','\"Fast Cast\"+5'}"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Malevolence{'INT+9','Mag. Acc.+10','\"Mag.Atk.Bns.\"+9','\"Fast Cast\"+4'}"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Naegling"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Nusku Shield"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Orion Beret +2"] = "Mog Wardrobe 3" -- Not used
    fixed_position["Perun +1"] = "Mog Wardrobe 3" -- Not used


    -- Mog Wardrobe 4 (used):
    fixed_position["Ankusa Gloves +1{'Enhances \"Beast Affinity\" effect'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    ...
    fixed_position["Despair Greaves{'Accuracy+10','Pet: VIT+7','Pet: Damage taken -3%'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    fixed_position["Desultor Tassets{'\"Sic\" and \"Ready\" ability delay -5','Pet: Accuracy+7 Pet: Rng. Acc.+7'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    ...
    fixed_position["Izdubar Mantle"] = "Mog Wardrobe 4" -- Used by 1 jobs: DRK
    ...
    fixed_position["Loyalist Sabatons{'STR+10','Attack+15','Phys. dmg. taken -3%','Haste+3'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    ...
    fixed_position["Pet Food Theta"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    fixed_position["Plun. Armlets +1{'Enhances \"Perfect Dodge\" effect'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: THF
    fixed_position["Sacro Mantle"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    ...
    fixed_position["Shulmanu Collar"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    ...
    fixed_position["Tali'ah Crackows +2"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    fixed_position["Tali'ah Gages +1"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    fixed_position["Tali'ah Manteel +2"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    fixed_position["Tali'ah Sera. +2"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    fixed_position["Tali'ah Turban +2"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    ...
    fixed_position["Valor. Hose{'Accuracy+23 Attack+23','Weapon skill damage +3%','AGI+4'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
    fixed_position["Valor. Hose{'Pet: Accuracy+28 Pet: Rng. Acc.+28','Pet: STR+2','Pet: Attack+15 Pet: Rng.Atk.+15'}"] = "Mog Wardrobe 4" -- Used by 1 jobs: BST
