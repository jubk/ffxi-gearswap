miaw_staves = {
    nuking = {
        Ice = { main = "Keraunos", sub = "Raptor Strap +1" },
        Dark = { main = "Keraunos", sub = "Raptor Strap +1" },
        Lightning = { main = "Keraunos", sub = "Raptor Strap +1" },
        Light = { main = "Keraunos", sub = "Raptor Strap +1" },
        Wind = { main = "Marin Staff", sub = "Raptor Strap +1" },
        Fire = { main = "Keraunos", sub = "Raptor Strap +1" },
        Earth = { main = "Keraunos", sub = "Raptor Strap +1" },
        Water = { main = "Keraunos", sub = "Raptor Strap +1" },
    },
    accuracy = {
